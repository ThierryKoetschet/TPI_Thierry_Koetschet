...
INSERT INTO `users` (`id`, `email`, `password`, `lastname`, `firstname`, `gender`, `birthdate`, `height`, `updated_at`, `created_at`) VALUES
	(7, 'thierry.koetschet@cpnv.ch', '$2y$10$3nPD44rTdxoWbjrbmpYDeOH3xBs3fLaREtgd9vOAFE1ZNhUhk9Dym', 'Koetschet', 'Thierry', 'Male', '1998-03-19', 192, '2023-05-30 05:39:38', '2023-05-16 05:12:59'),
...
-- Listage des données de la table infofit.users_has_foodstuffs : ~6 rows (environ)
